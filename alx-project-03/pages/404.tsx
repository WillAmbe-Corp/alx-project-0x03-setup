...
const Custom404 = () => {
    return(
        <div className="min-h-screen bg-gradient-to-r from-purple-500 to-pink-500 flex flex-col justify-center items-center text-white">
            ...
            {/* Buttont to navigate back */}
            <Link href="/" className="flex items-center space-x-2 bg-blue-500 hoer:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                <FaHome size={20} />
